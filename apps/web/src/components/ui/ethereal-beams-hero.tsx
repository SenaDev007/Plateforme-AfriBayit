...
const Beams: FC<BeamsProps> = ({
  ...
  vec3 getNormal(vec3 pos) {
    ...
    gl_FragColor.rgb -= randomNoise / 15. * uNoiseIntensity;`,
        ...
        material: { fog: true },
        uniforms: {
          diffuse: new THREE.Color(...hexToNormalizedRGB('#003087')), // AfriBayit Navy
  ...
  return (
    <CanvasWrapper>
      ...
      <color attach="background" args={['#001f5b']} /> {/* Deep Navy Background */}
...
const Button = ({
  ...
  const variants = {
    ...
    outline:
      'border border-gold/30 bg-white/5 backdrop-blur-xl text-white hover:bg-white/10 hover:border-gold/50',
...
/**
 * Ethereal Beams Hero — AfriBayit Edition
 *
 * A mesmerizing hero section featuring animated 3D light beams with Navy & Gold branding.
 * Integrated with the official SearchBar for high-conversion real estate exploration.
 */
export default function EtherealBeamsHero() {
  return (
    <div className="bg-navy-deep relative min-h-screen w-full overflow-hidden">
      {/* Beams Background */}
      <div className="absolute inset-0 z-0 opacity-80">
        <Beams
          ...
          beamHeight={18}
          beamNumber={15}
          lightColor="#D4AF37" // AfriBayit Gold
          speed={2.5}
          noiseIntensity={2}
          scale={0.15}
          rotation={43}
      ...
      <div className="relative z-10 flex min-h-screen items-center pt-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            {/* Badge */}
            <div className="text-gold mb-8 inline-flex items-center rounded-full border border-white/10 bg-white/5 px-4 py-2 text-[10px] font-bold uppercase tracking-widest backdrop-blur-xl">
              <Star className="text-gold mr-2 h-3 w-3" />
              {"L'Excellence Immobilière Africaine"}
            </div>
      ...
      <div className="from-navy-deep to-navy-deep/40 pointer-events-none absolute inset-0 z-0 bg-gradient-to-t via-transparent" />
    </div>
  );
}
