...
/**
 * Premium Scroll Expansion Hero for AfriBayit.
 * Features: Immersive scroll-driven expansion, Navy & Gold aesthetic.
 */
const ScrollExpandMedia = ({
  ...
  return (
    <div
      ref={sectionRef}
      className="bg-navy overflow-x-hidden transition-colors duration-700 ease-in-out"
    >
        ...
        <div className="relative flex min-h-[100dvh] w-full flex-col items-center">
          ...
          <div className="container relative z-10 mx-auto flex flex-col items-center justify-start">
            <div className="relative flex h-[100dvh] w-full flex-col items-center justify-center">
              ...
              >
                {mediaType === 'video' ? (
                  <div className="pointer-events-none relative h-full w-full">
                    ...
                    />
                    <motion.div
                      className="bg-navy/30 absolute inset-0 rounded-xl"
                      initial={{ opacity: 0.7 }}
                  ...
                  <div className="relative h-full w-full">
                    ...
                    />
                    <motion.div
                      className="bg-navy/50 absolute inset-0 rounded-xl"
                      initial={{ opacity: 0.7 }}
                ...
                <div className="relative z-10 mt-4 flex flex-col items-center text-center transition-none">
                  ...
                  {scrollToExpand && (
                    <p
                      className="text-gold font-sans font-bold uppercase tracking-widest"
                      style={{ transform: `translateX(${textTranslateX}vw)` }}
                    >
                      {scrollToExpand}
                    </p>
              ...
              >
                <motion.h2
                  className="text-hero-mobile md:text-hero-desktop text-gold font-serif font-bold transition-none"
                  style={{ transform: `translateX(-${textTranslateX}vw)` }}
                >
                  {firstWord}
                </motion.h2>
                <motion.h2
                  className="text-hero-mobile md:text-hero-desktop text-gold text-center font-serif font-bold transition-none"
                  style={{ transform: `translateX(${textTranslateX}vw)` }}
                >
                  {restOfTitle}
                </motion.h2>
